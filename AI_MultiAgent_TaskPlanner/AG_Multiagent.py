...
st.set_page_config(page_title="Autogen Multi-Agent Chat created by AZIM MUJAWAR", page_icon="**", layout="wide" )
st.title("Autogen Multi-Agent Chat created by AZIM MUJAWAR") 
